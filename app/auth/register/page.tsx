...
<div className="h-screen lg:flex w-screen">
	<div
		...
		<div>
			...
			<h1 className="text-white font-bold text-4xl font-sans"><img src="bot.png" alt="dhf" className="w-1/4" />BaristerBot</h1>
			<p className="text-white mt-1">Now you can ask your law related questions directly from Barrister Bot</p>
	...
	<div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
        ...
        signIn('credentials', {
          ...
          callbackUrl: `${window.location.origin}/dashboard`
			...
			<p className="text-sm font-normal text-gray-600 mb-7">Create an account with us</p>
				...
				<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
						...
						<div className="flex items-center border-2 py-2 px-3 rounded-2xl">
							...
							<br />
               <span className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Already have account ?</span> <Link href="/">Login Now</Link>
		</form>
	</div>
</div>
    </main>
